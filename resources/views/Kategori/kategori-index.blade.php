            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered">
                  ...
                  <tbody>
                    <!-- LOOPING DATA KATEGORI SESUAI JUMLAH DATA YANG ADA DI VARIABLE $KATEGORI -->
                    ...
                    <tr>
                      ...
                      <td>{{ $val->parent ? $val->parent->nama_kategori : '-' }}</td>
                      ...
                      <td>
                        ...
                        <form action="{{ route('KategoriBarang.destroy', $val->id) }}" method="post">
                          <!-- KONVERSI DARI @CSRF & @METHOD AKAN DIJELASKAN DIBAWAH -->
                          @csrf
                          @method('DELETE')

                          <a href="{{ route('KategoriBarang.edit', $val->id) }}" class="btn btn-warning btn-sm">Edit</a>
                          <button class="btn btn-danger btn-sm">Hapus</button>
                        </form>
                      </td>
                    </tr>
                    <!-- JIKA DATA KATEGORI KOSONG, MAKA AKAN DIRENDER KOLOM DIBAWAH INI  -->
                    @empty
                    <tr>
